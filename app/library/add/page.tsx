...
export default async function AddAnimePage({
  ...
  const defaultStatus = returnTo === "/backlog" ? "PLAN_TO_WATCH" : undefined;

  return (
    <div className="max-w-2xl">
      <h2 className="text-2xl font-bold text-white mb-6">Add Anime</h2>
      <AddAnimeForm people={people} franchises={franchises} returnTo={returnTo} defaultStatus={defaultStatus} />
    </div>
  );
}
